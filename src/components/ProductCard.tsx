...
export function ProductCard({ product, onAddToCart, onViewDetails }: ProductCardProps) {
  ...
  return (
    <div className="group relative">
      ...
      <div className={`relative backdrop-blur-xl border rounded-xl sm:rounded-2xl lg:rounded-3xl overflow-hidden shadow-xl transition-all duration-500 sm:transform sm:hover:-translate-y-2 ${
        isDark 
        ...
        <div className="p-3 sm:p-4 lg:p-6 pt-0 sm:pt-0 lg:pt-0">
          <div className="flex gap-2 sm:gap-3">
            <button
              onClick={() => onViewDetails(product)}
              className={`flex-1 backdrop-blur-xl border font-medium py-2 sm:py-2.5 lg:py-3 rounded-lg sm:rounded-xl transition-all duration-200 text-xs sm:text-sm lg:text-base ${
                isDark 
